            ...
            <View className='flex-1'>
                <View style={{ height: SCREEN_HEIGHT * 0.45 }}>
                    ...
                    >
                        ...
                        <Marker coordinate={{ latitude: data.pickupLat, longitude: data.pickupLng }} title='Pickup'>
                            <View className='w-8 h-8 rounded-full bg-orange-500 items-center justify-center border-2 border-white'>
                                <MaterialIcons name='location-on' size={16} color='white' />
                            </View>
                        </Marker>
                        <Marker coordinate={{ latitude: data.dropoffLat, longitude: data.dropoffLng }} title='Drop-off'>
